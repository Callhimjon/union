...
use ucs03_zkgm::{
    ...
    com::{
        ...
        INSTR_VERSION_1, INSTR_VERSION_2, OP_BATCH, OP_FORWARD, OP_STAKE, OP_TOKEN_ORDER,
        OP_UNSTAKE, OP_WITHDRAW_STAKE, TOKEN_ORDER_KIND_ESCROW, TOKEN_ORDER_KIND_INITIALIZE,
